...
img = cv2.imread("shapes.jpg", cv2.IMREAD_GRAYSCALE) #şekilleri greyscale yaptık
_, threshold = cv2.threshold(img, 240, 255, cv2.THRESH_BINARY) #arka planı beyaz ve tüm görüntüleri siyah yaptık eşik değeri vererek
